...
parser.add_argument('--face_landmarks_detector_path', default='/root/autodl-fs/code/infer_deliver/weights/face_landmarker.task',
						type=str, help='Path to face landmarks detector')
parser.add_argument('--with_face_mask', default=0,
...
args.img_size = 96
args.checkpoint_path = '/root/autodl-fs/code/infer_deliver/finetune_wav2lip/newmodel/checkpoint_step000258100.pth'
args.face = '/root/autodl-fs/code/infer_deliver/test_data/videos/mk.mp4'
args.audio = '/root/autodl-fs/code/infer_deliver/test_data/audios/mk.mp3'

#base_options = python.BaseOptions(model_asset_path=args.face_landmarks_detector_path)
#options = vision.FaceLandmarkerOptions(base_options=base_options,
#                                       output_face_blendshapes=True,
#                                       output_facial_transformation_matrixes=True,num_faces=500)
#
...
def face_mask_from_image(image, face_landmarks_detector):
	...
	return cv2.fillPoly(mask, pts=[convex_hull.squeeze().astype(np.int32)], color=args.with_face_mask)
